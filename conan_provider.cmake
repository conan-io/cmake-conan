...
macro(construct_profile_argument argument_variable profile_list)
    ...
    message("profile_list: ${profile_list}")
    ...
    list(TRANSFORM _profile_list REPLACE "autodetect" "${CMAKE_BINARY_DIR}/conan_host_profile")
    list(TRANSFORM _profile_list PREPEND ${_arg_flag})
    set(${argument_variable} ${_profile_list})
    message("ARG: ${${argument_variable}}")
...
macro(conan_provide_dependency method package_name)
    ...
    if(NOT CONAN_INSTALL_SUCCESS)
        ...
        if("autodetect" IN_LIST CONAN_HOST_PROFILE)
...
set(CONAN_HOST_PROFILE "autodetect" CACHE STRING "Conan host profile")
