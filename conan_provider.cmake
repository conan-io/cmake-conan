...
function(detect_arch ARCH)
    if(ANDROID)
        ...
        elseif(ANDROID_ABI STREQUAL x86)
            ...
            message(FATAL_ERROR "CMake-Conan: Android ABI, ${ANDROID_ABI}, is unsupported")
        endif()
        message(STATUS "CMake-Conan: android_abi=${ANDROID_ABI}")
...
function(detect_cxx CXX_STANDARD LIB_CXX)
...
function(detect_host_profile output_file)
    ...
    detect_cxx(MYCXX_STANDARD MYLIB_CXX)
