...
function(detect_compiler COMPILER COMPILER_VERSION COMPILER_UPDATE COMPILER_RUNTIME COMPILER_RUNTIME_TYPE)
    ...
    if(_COMPILER MATCHES MSVC)
        ...
        if(_COMPILER_VERSION GREATER_EQUAL 191)
            string(SUBSTRING ${MSVC_VERSION} 3 1 _COMPILER_UPDATE)
        endif()
    ...
    if(_COMPILER MATCHES "msvc" AND _COMPILER_UPDATE MATCHES "[0-9]")
      message(STATUS "CMake-Conan: [settings] compiler.update=${_COMPILER_UPDATE}")
    endif()
    ...
    if(_COMPILER MATCHES "msvc" AND _COMPILER_UPDATE MATCHES "[0-9]")
      set(${COMPILER_UPDATE} ${_COMPILER_UPDATE} PARENT_SCOPE)
    endif()
...
function(detect_host_profile output_file)
    ...
    detect_arch(MYARCH)
    detect_compiler(MYCOMPILER MYCOMPILER_VERSION MYCOMPILER_UPDATE MYCOMPILER_RUNTIME MYCOMPILER_RUNTIME_TYPE)
    ...
    if(MYCOMPILER_UPDATE)
        string(APPEND PROFILE compiler.update=${MYCOMPILER_UPDATE} "\n")
    endif()
