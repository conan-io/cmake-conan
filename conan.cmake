...
function(conan_cmake_settings result)
    ...
    if (${CMAKE_C_COMPILER_ID} STREQUAL GNU)
        ...
        set(_SETTINGS ${_SETTINGS} -s compiler=gcc -s compiler.version=${MAJOR}.${MINOR})
        if (USING_CXX)
    ...
    elseif(${CMAKE_C_COMPILER_ID} STREQUAL MSVC)
        ...
        elseif (MSVC_C_ARCHITECTURE_ID MATCHES "86")
            set(_SETTINGS ${_SETTINGS} -s arch=x86)
        else ()
            message(FATAL_ERROR "Conan: Unknown MSVC architecture [${MSVC_C_ARCHITECTURE_ID}]")
        endif()
